    ...
    module _outer_wall() {
        group() {
            ...
            if (add_lip) {
                ...
                y = has_groove ? wall : x;
                length = has_groove ? _length - y - x : _length - y * 2;
    ...
    module _(
        ...
        render() intersection() {
            enclosure_half(
                ...
                groove_depth = 2.5 / 3,
                groove_height = LIP_BOX_DEFAULT_LIP_HEIGHT * .67,
...
* __test_enclosure_lip_tolerances([0, .05, .1, .2]);
